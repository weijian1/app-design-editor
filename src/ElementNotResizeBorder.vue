<template>
  <div class="element-box" 
    ...
    <template v-if="mouseEnter || selected">
        ...
        <div class="bar bar-radius bar-rn"></div>
        <div class="bar bar-radius bar-rs"></div>
        <div class="bar bar-radius bar-rw"></div>
        <div class="bar bar-radius bar-re"></div>
        <div class="bar bar-radius bar-rnw"></div>
        <div class="bar bar-radius bar-rne"></div>
        <div class="bar bar-radius bar-rsw"></div>
        <div class="bar bar-radius bar-rse"></div>
    </template>
  </div>
</template>
...
export default {
  ...
  data() {
      return {
          mouseEnter: false,
          specialCssProperty: ['opacity', 'paddingLeft', 'paddingTop', 'paddingRight', 'paddingBottom', 'color', 'fontWeight', 'fontStyle', 'textDecoration'],
          eventData: {
            tempOpacity: 1,
            currentDirection: '',
            originElementPos: {
